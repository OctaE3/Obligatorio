            ...
            [],
             (tx, res) =>{
              ...
              if (res.rows.length == 0) {
                ...
                txn.executeSql(
                  'CREATE TABLE IF NOT EXISTS treatment(treatment_id INTEGER PRIMARY KEY AUTOINCREMENT, treatment_name VARCHAR(25), vehicle VARCHAR(7), inDate VARCHAR(10), finDate VARCHAR(10), price VARCHAR(9))',
                  []
                );
              }
            }
